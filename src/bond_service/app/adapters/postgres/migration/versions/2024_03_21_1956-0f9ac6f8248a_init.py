...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(),
            nullable=True,
            comment="Наименование облигации",
        ),
        sa.Column(
            "isin",
            sa.String(),
    ...
    op.create_index(
        op.f("ix_portfolios_id"), "portfolios", ["id"], unique=True
    )
    op.create_table(
        "portfolio_bonds",
        sa.Column("id", sa.UUID(), nullable=False, comment="Идентификатор"),
        ...
        sa.ForeignKeyConstraint(
            ["bond_isin"], ["bonds.isin"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_portfolio_bonds_id"), "portfolio_bonds", ["id"], unique=True
    )
    op.create_table(
        "operations",
        sa.Column("id", sa.UUID(), nullable=False, comment="Идентификатор"),
        ...
        sa.Column(
            "date", sa.DateTime(), nullable=True, comment="Дата покупки"
        ),
        sa.Column(
            "type",
            sa.Enum("purchase", "sell", name="bondtype"),
            nullable=True,
        ...
        sa.ForeignKeyConstraint(
            ["portfolio_bond_id"], ["portfolio_bonds.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_operations_id"), "operations", ["id"], unique=True
    )
