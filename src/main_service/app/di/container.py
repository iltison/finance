...
def get_container() -> Container:
    ...
    container.add_scoped_by_factory(build_get_portfolios_service, GetPortfoliosService)
    container.add_scoped_by_factory(build_get_portfolio_service, GetPortfolioService)
