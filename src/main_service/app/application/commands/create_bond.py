...
from main_service.app.adapters.bond_repo import BondDAOInterface
...
from main_service.app.domain.exeption import ValueExistError, ServiceError
...
class CreateBondService:
    ...
    async def execute(self, command: CreateBondCommand) -> CommandCreateBondResult:
        ...
        async with self.__uow:
            ...
            if bond is not None:
                ...
                return CommandCreateBondResult().failed(exception=ValueExistError(f"Bond {command.name} exist "))
